public class ThreadGestioneServizioChat implements Runnable {
    ...
    public ThreadGestioneServizioChat(int numeroMaxConnessioni, List lista) {
        ...
        this.lista = lista;
        this.listaConnessioni = new ThreadChatConnessionni[this.nrMaxConnessioni];
        me = new Thread(this);
        me.start();
    }
    ...
    public void run() {
        ...
        // istanzio la connessione del server per la chat
        try {
            serverChat = new SeverSocket(6789);
        } catch (Exception e) {
    ...
    public void spedisciMessaggio(Strin mex) {
